		...
		<div className="flex flex-col items-center justify-center bg-white text-black px-8 py-16 xl:px-32">
			<div className="max-w-7xl w-full">
				...
				<div className="flex flex-col">
					...
					/>
					<button className="btn xl:btn-wide bg-white border-2 border-gray-900 hover:bg-orange-400 hover:border-orange-400 hover:text-white hover:drop-shadow-lg transition-all ease-in-out duration-300 rounded-full">
						Submit
					</button>
				</div>
			</div>
