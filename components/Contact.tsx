				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-7xl">
					...
					<div className="flex flex-col items-left justify-start w-full">
						<form>
							...
							<button className="btn btn-block lg:btn-wide bg-white border-2 border-gray-900 hover:bg-orange-400 hover:border-orange-400 hover:text-white hover:drop-shadow-lg transition-all ease-in-out duration-300 rounded-sm">
								Submit
							</button>
						</form>
					</div>
